goog.provide('chartEditor.ui.button.Base');
 ...
 */
chartEditor.ui.button.Base = function(opt_content, opt_renderer, opt_domHelper) {
  chartEditor.ui.button.Base.base(this, 'constructor', opt_content || '', opt_renderer, opt_domHelper);
...
goog.inherits(chartEditor.ui.button.Base, goog.ui.Button);
 ...
 */
chartEditor.ui.button.Base.prototype.setIcon = function(iconClass, opt_index) {
 ...
 * @private
 */
chartEditor.ui.button.Base.prototype.setIcon_ = function() {
...
/** @override */
chartEditor.ui.button.Base.prototype.createDom = function() {
  chartEditor.ui.button.Base.base(this, 'createDom');
