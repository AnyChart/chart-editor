 ...
 */
chartEditor.ui.panel.ganttProject.elements.TaskElement = function(model, index,  opt_domHelper) {
  chartEditor.ui.panel.ganttProject.elements.TaskElement.base(this, 'constructor', model, index,  'Task element', opt_domHelper);
