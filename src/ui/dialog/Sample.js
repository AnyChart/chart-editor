goog.provide('chartEditor.ui.dialog.Sample');
...
/** @inheritDoc */
chartEditor.ui.dialog.Sample.prototype.createDom = function() {
  chartEditor.ui.dialog.Sample.base(this, 'createDom');
  goog.dom.classlist.add(this.getDialogElement(), goog.getCssName('anychart-ce-dialog-sample'));
};
 ...
 */
chartEditor.ui.dialog.Sample.prototype.updateContent = function(sampleId) {
  var url;
  switch (sampleId) {
    case '0':
