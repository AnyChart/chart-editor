goog.provide('chartEditor.ui.control.button.Base');
 ...
 */
chartEditor.ui.control.button.Base = function(opt_content, opt_renderer, opt_domHelper) {
  chartEditor.ui.control.button.Base.base(this, 'constructor', opt_content || '', opt_renderer, opt_domHelper);
...
goog.inherits(chartEditor.ui.control.button.Base, goog.ui.Button);
 ...
 */
chartEditor.ui.control.button.Base.prototype.setIcon = function(iconClass, opt_index) {
 ...
 * @private
 */
chartEditor.ui.control.button.Base.prototype.setIcon_ = function() {
...
/** @override */
chartEditor.ui.control.button.Base.prototype.createDom = function() {
  chartEditor.ui.control.button.Base.base(this, 'createDom');
