goog.provide('chartEditor.dialog.Data');
 ...
 */
chartEditor.dialog.Data = function(opt_class, opt_useIframeMask, opt_domHelper) {
  chartEditor.dialog.Data.base(this, 'constructor', opt_class, opt_useIframeMask, opt_domHelper);
...
goog.inherits(chartEditor.dialog.Data, chartEditor.dialog.Base);


/** @inheritDoc */
chartEditor.dialog.Data.prototype.createDom = function(){
  chartEditor.dialog.Data.base(this, 'createDom');
 ...
 */
chartEditor.dialog.Data.prototype.updateContent = function(dialogType, opt_dataType){
  ...
  if (this.dataType_ == 'csv') {
    ...
    this.csvIgnoreFirstRow_ = new chartEditor.checkbox.Base();
    ...
    this.csvTrailingSpaces_ = new chartEditor.checkbox.Base();
...
/** @return {string} */
chartEditor.dialog.Data.prototype.getType = function(){
  return this.type_;
};
 ...
 * @return {?string}
 */
chartEditor.dialog.Data.prototype.getInputValue = function(){
 ...
 * @return {?string}
 */
chartEditor.dialog.Data.prototype.getInput2Value = function(){
 ...
 */
chartEditor.dialog.Data.prototype.getCSVSettings = function() {
  return {
 ...
 * @private
 */
chartEditor.dialog.Data.prototype.processSpecialChars_ = function(string) {
